...
export function initDb() {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS learning_lessons (
      ...
      author TEXT NOT NULL DEFAULT 'auto_learning',
  ...
  ensureColumn('learning_lessons', 'author', "TEXT DEFAULT 'auto_learning'");
  ...
  stratInsert.run('sniper', 'Sniper', 1, JSON.stringify({
    ...
    source_require_fee: false,
    source_require_graduated: true,
    source_require_trending: true,
    ...
    trailing_percent: 5,
    trailing_tiers_enabled: true,
    trailing_floor_at_percent: 10,
    trailing_floor_percent: 5,
    trailing_tier_1_at_percent: 20,
    trailing_tier_1_percent: 10,
    trailing_tier_2_at_percent: 30,
    trailing_tier_2_percent: 15,
    trailing_tier_3_at_percent: 60,
    trailing_tier_3_percent: 20,
    trailing_tier_4_at_percent: 100,
    trailing_tier_4_percent: 30,
    partial_tp: false,
    partial_tp_at_percent: 0,
    partial_tp_sell_percent: 0,
    max_hold_ms: 900000,
    early_exit_enabled: true,
    early_exit_check_after_ms: 90000,
    early_exit_min_peak_pnl_percent: 5,
    early_exit_max_current_pnl_percent: 0,
    early_loss_guard_enabled: true,
    early_loss_check_after_ms: 60000,
    early_loss_window_ms: 180000,
    early_loss_exit_pnl_percent: -7,
    use_llm: true,
    llm_min_confidence: 50,
    profit_cooldown_enabled: true,
    profit_cooldown_scope: 'mint',
    profit_cooldown_min_profit_percent: 15,
    profit_cooldown_max_wins: 1,
    profit_cooldown_min_loss_percent: 17,
    profit_cooldown_max_losses: 2,
    profit_cooldown_minutes: 60,
    chart_indicators_enabled: true,
    chart_indicators_hard_filter: false,
    indicator_timeframe: '1m',
    supertrend_required: true,
    ...
    rsi_min: 45,
    rsi_max: 78,
    bbrsi_guard_enabled: true,
    bbrsi_overbought_rsi: 78,
    bbrsi_max_band_pos: 105,
    bb_buy_pressure_guard_enabled: true,
    bb_buy_pressure_min_band_pos: 80,
    bb_buy_pressure_min_ratio: 1.5,
    bb_period: 20,
    bb_stddev: 2,
  }), ts);
  ...
  stratInsert.run('dip_buy', 'Dip Buy', 0, JSON.stringify({
    ...
    source_require_fee: false,
    source_require_graduated: false,
    source_require_trending: false,
    ...
    trailing_enabled: true,
    trailing_percent: 15,
    trailing_tiers_enabled: false,
    trailing_floor_at_percent: 0,
    trailing_floor_percent: 0,
    trailing_tier_1_at_percent: 0,
    trailing_tier_1_percent: 0,
    trailing_tier_2_at_percent: 0,
    trailing_tier_2_percent: 0,
    trailing_tier_3_at_percent: 0,
    trailing_tier_3_percent: 0,
    trailing_tier_4_at_percent: 0,
    trailing_tier_4_percent: 0,
    partial_tp: false,
    partial_tp_at_percent: 0,
    partial_tp_sell_percent: 0,
    max_hold_ms: 0,
    early_exit_enabled: false,
    early_exit_check_after_ms: 0,
    early_exit_min_peak_pnl_percent: 0,
    early_exit_max_current_pnl_percent: 0,
    early_loss_guard_enabled: false,
    early_loss_check_after_ms: 0,
    early_loss_window_ms: 0,
    early_loss_exit_pnl_percent: 0,
    use_llm: true,
    llm_min_confidence: 60,
    profit_cooldown_enabled: false,
    profit_cooldown_scope: 'mint',
    profit_cooldown_min_profit_percent: 5,
    profit_cooldown_max_wins: 2,
    profit_cooldown_min_loss_percent: 0,
    profit_cooldown_max_losses: 0,
    profit_cooldown_minutes: 30,
    chart_indicators_enabled: false,
    chart_indicators_hard_filter: false,
    indicator_timeframe: '1m',
    supertrend_required: false,
    supertrend_atr_period: 10,
    supertrend_multiplier: 3,
    rsi_guard_enabled: false,
    rsi_period: 14,
    rsi_min: 0,
    rsi_max: 0,
    bbrsi_guard_enabled: false,
    bbrsi_overbought_rsi: 0,
    bbrsi_max_band_pos: 0,
    bb_buy_pressure_guard_enabled: false,
    bb_buy_pressure_min_band_pos: 80,
    bb_buy_pressure_min_ratio: 1.5,
    bb_period: 20,
    bb_stddev: 2,
  ...
  stratInsert.run('degen', 'Degen', 0, JSON.stringify({
    ...
    rsi_max: 82,
    bbrsi_guard_enabled: true,
    bbrsi_overbought_rsi: 82,
    bbrsi_max_band_pos: 110,
    bb_buy_pressure_guard_enabled: false,
    bb_buy_pressure_min_band_pos: 80,
    bb_buy_pressure_min_ratio: 1.5,
    bb_period: 20,
